...
<head>
    ...
    <title>MovieFinder Registrierung</title>
        ...
        <div class="row g-4 align-items-center">
            <div class="col-md-6">
                <div class="text-center mb-4">
                    ...
                    <p>Bitte wähle einen Username und ein Passwort</p>
                </div>

                <form method="POST" action="" class="p-4 bg-dark bg-opacity-25 rounded-3 border-0 shadow">
                    <?php if (!empty($error)): ?>
                    ...
                    <div class="mb-4">
                        <label for="field2_repeat" class="form-label text-secondary small">Passwort wiederholen</label>
